...
$query  = "select * from orderitems where username = '$name'";
...
<main role="main" class="container">
  <div class="jumbotron" style="margin-top:10%;background-color:aliceblue;">
    <div style="float: left;margin-top:-2%;"><h1>Your <span style="color: burlywood;font-style: italic;">Orders</span></h1></div>
  ...
  <div class="container">
    ...
    <table>
    <tr>
    <th class="paddings">Restruant Name</th>
    ...
    ?>
    <tr>
    <td class="paddings"><?php echo $rows["restusername"] ?></td>
