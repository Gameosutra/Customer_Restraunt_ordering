...
<main role="main" class="container">
  <div class="jumbotron" style="margin-top:10%;background-color:aliceblue;">
    <div style="float: left;margin-top:-2%;"><h1>Menu <span style="color: burlywood;font-style: italic;">Items</span></h1></div>
    <div style="float:right;margin-top:-2%;">
    <a class="btn btn-lg btn-primary" href="restnewitem.php" role="button">
        + Add New Items
      </a>
  ...
  <div class="container">
    ...
    font-weight: 500;
    font-size: 30px;">Your <span style="color: burlywood;font-style: italic;">Menu</span></h3>
    <table>
    <tr>
