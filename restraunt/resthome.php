...
<main role="main" class="container">
  <div class="jumbotron" style="margin-top:10%;background-color:aliceblue;">
    <div style="float: left;margin-top:-2%;text-transform: capitalize;"><h1>Welcome <span style="color: burlywood;font-style: italic;"><?php echo $_SESSION['restusername'];?></span></h1></div>
    <div style="float:right;margin-top:-2%;">
      <a class="btn btn-lg btn-primary" href="viewitems.php" role="button">
        View Menu
      </a>
      <a class="btn btn-lg btn-primary" href="vieworders.php" role="button">
        View Orders
      </a>
    </div>
  </div>
  ...
  <div class="row">
    ...
    <aside class="col-md-4 blog-sidebar">
      <div class="p-4 mb-3 bg-light rounded">
        ...
        <p class="mb-0">A <span style="color: burlywood;font-style: italic;">Restaurant</span> (French: [ʁɛstoʁɑ̃] (About this soundlisten)), or an eatery, is a business that prepares and serves food and drinks to customers.[1] Meals are generally served and eaten on the premises, but many restaurants also offer take-out and food delivery services. Restaurants vary greatly in appearance and offerings, including a wide variety of cuisines and service models ranging from inexpensive fast food restaurants and cafeterias, to mid-priced family restaurants, to high-priced luxury establishments.</p>
      </div>
    </aside><!-- /.blog-sidebar -->
